...
public class AdminLogin1 extends JFrame implements MouseListener, FocusListener , ActionListener
{
  ...
  int w,h;
	...
	public void paintComponent(Graphics g)
		{
			g.drawImage(new ImageIcon("teacher.png").getImage(),20,30,160,230,null);
		}
	};
  ...
  JLabel lbl=new JLabel("TEACHER LOGIN ");
  JLabel lbl1=new JLabel("Teacher Name");
  JTextField txt=new JTextField(20);
  JLabel lbl2=new JLabel("Teacher -ID ");
  ...
  public void mouseClicked(MouseEvent e)
   {
	 ...
	 public void showData()
    {
       ...
       // JLabel l, l0;
        ...
        try
        {
            pst = con.prepareStatement("select tname,tid,tpass from teacher_login where tname=?  and tid=? and tpass=?");
