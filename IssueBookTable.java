...
class IssueBookTable extends JFrame implements MouseListener,ActionListener
{
	...
	JLabel l=new JLabel("ISSUED BOOK DETAILS");
	...
	int w,h,r;
	Color col2,col1;
	String[] columns={"Accession No","Book title","Member ID","Department","Issue Date","Return Date"};
	Toolkit toolkit;
	Dimension dim;
	Connection con;
	...
	static String data1;
	{
		try
		{
			...
			pst=con.prepareStatement("SELECT accession,title,mem_id,subject,issue_date,return_date FROM issue_book");
