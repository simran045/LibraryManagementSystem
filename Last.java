...
public class Last extends JFrame implements ActionListener, MouseListener ,FocusListener
{
  ...
  /* {
		  ...
		  
	{
     ...
     //defining components
	  ...
	  JLabel lbl=new JLabel("ADD NEW LIBRARIAN ");
	 ...
	 JComboBox cbQues2 = new JComboBox();JComboBox cbQues3 = new JComboBox();JLabel l3= new JLabel("Question #3");JLabel t3= new JLabel("Answer :");JTextField tx3=new JTextField(300) ; JLabel l2= new JLabel("Question #2");JLabel t2= new JLabel("Answer :"); JTextField tx2=new JTextField(300);
    ...
    JButton btn8=new JButton("ADMINISTRATOR LOGIN");
     ...
     {	  
	    ...
	    btnView.setBounds(870,37,170,30);
	    ...
	    btnSign.setBounds(1100,37,100,30);
	    btnSign.setBorder(BorderFactory.createEmptyBorder(2,2,2,2));
	    ...
	    btnLogin.setBorder(BorderFactory.createEmptyBorder(2,2,2,2));
       ...
       public void focusGained(FocusEvent e)
   {
	...
	if(e.getSource()==area)
	{
     area.setBackground(new Color(240,230,140)); 
    }
   ...
   public void actionPerformed( ActionEvent ae)
   {
     if(ae.getSource()== btn)
	 {
	  ...
	  try
		  {
				pst=con.prepareStatement("insert into lib_registration1 values(?,?,?,?,?,?,?,?,?,?)");
				...
				pst.setString(7,genC.getSelectedItem().toString());
				pst.setString(8,area.getText());
				...
				{
				       JOptionPane.showMessageDialog(this,"please enter password","Registration Failed",JOptionPane.WARNING_MESSAGE);
			    }
				else if(str2.isEmpty())
				{
				       JOptionPane.showMessageDialog(this,"confirm password field is empty","Registration Failed",JOptionPane.WARNING_MESSAGE);
			    }
				...
				{
				       JOptionPane.showMessageDialog(this,"please enter your answer","Registration Failed",JOptionPane.WARNING_MESSAGE);
			    }
				else if(!(str1.equals(str2)))
				 { 
				 JOptionPane.showMessageDialog(this," your password don't match ! ","Librarian not registered",JOptionPane.WARNING_MESSAGE);
				 }
					  else 
				    {
					  pst.executeUpdate(); 
                      JOptionPane.showMessageDialog(this,"Successfully registered.Now you can login","success",JOptionPane.INFORMATION_MESSAGE);
				    }
				  }
		...
		if(ae.getSource()==btnReset)
		{
					...
					txt2.setBackground(col2);
					pass.setBackground(col2);
					passc.setBackground(col2);
					txt5.setBackground(col2);
					txt6.setBackground(col2);
					genC.setBackground(col2);
					area.setBackground(col2);
			        txt1.setText("");
					txt2.setText("");
					pass.setText("");
					passc.setText("");
