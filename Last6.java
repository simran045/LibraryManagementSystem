...
public class Last6 extends JFrame implements MouseListener, FocusListener , ActionListener
{
		  ...
		  
	{
	 ...
	 JPanel p6=new JPanel()
	 {
	  public void paintComponent(Graphics g)
		{
			g.drawImage(new ImageIcon("student.png").getImage(),20,30,160,230,null);
		}
	 };
  ...
  JLabel lbl=new JLabel("STUDENT LOGIN ");
  ...
  super("LIBRARY MANAGMENT SYSTEM OF NIELIT PATNA CENTER ");
  ...
  public void mouseClicked(MouseEvent e)
   {
	...
	public void mouseExited(MouseEvent e)
	{
		...
		if(e.getSource()==btn6)
		{
		btn6.setForeground(col1);
		}
		if(e.getSource()==btn7)
		{
		btn7.setForeground(col1);
		}
		if(e.getSource()==btn8)
		{
	 ...
	 public void showData()
    {
       ...
       // JLabel l, l0;
        ...
        try
        {
            pst = con.prepareStatement("select sname,sid,spass from student_login where sname=?  and sid=? and spass=?");
			...
			/*else if(!(t1.getText().equals(t3.getText())))
			{
			     JOptionPane.showMessageDialog(null, "Please Enter Name");
			}*/
            ...
            {
                JOptionPane.showMessageDialog(null,
                   "Incorrect Name or Login-Id or password..Try Again with correct detail");
				   //txt.setText("");
				  // txt1.setText("");
                   //pass.setText("");
            }
