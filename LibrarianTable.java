...
class LibrarianTable extends JFrame implements MouseListener,ActionListener
{
	...
	Connection con;
	ResultSet rst;
	String[] columns={"Librarian ID","Librarian Name","Date-of-Birth","Contact","Gender","Address"};
	...
	static String data;
	{
		try
		{
			...
			pst=con.prepareStatement("SELECT Lib_id,Lib_name,Lib_dob,Lib_contact,Lib_gender,Lib_address  FROM lib_registration1");
	 ...
	 LibrarianTable()
	{
		...
		w=(int)dim.getWidth();
		h=(int)dim.getHeight();
		JLabel l=new JLabel("LIBRARIAN DETAILS");
	    add(p);
		tab.setRowHeight(35);
		...
		p4.setLayout(null);
	     ...
	     btnContact.setBounds(1040,30,170,25);
	     ...
	     btnLogout.setBounds(1220,30,100,25);
