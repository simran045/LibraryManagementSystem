...
class MemberTable extends JFrame implements MouseListener
{
	...
	static String data1;
	{
		try
		{
			...
			dtm.addColumn("Accession Number");
			dtm.addColumn("Member Name");
			dtm.addColumn("Librarian");
			dtm.addColumn("Subject");
			dtm.addColumn("Contact");
			dtm.addColumn("Book Issued Date");
			tab.setModel(dtm);
			pst=con.prepareStatement("Select count(*) from issueBook");
