...
class MemberTable extends JFrame implements MouseListener,ActionListener
{
	...
	JLabel l1=new JLabel("Total members :");
	JLabel l2=new JLabel();
	JLabel l=new JLabel("MEMBER DETAILS");
	...
	Toolkit toolkit;
	Dimension dim;
	String[] item={"Member Id","Member Name","Department","Designation","Session","Contact","Status","Email"};
	Connection con;
	...
	static String data1;
	{
		try
		{
			...
			pst=con.prepareStatement("SELECT  mem_id,mem_name,mem_depart,mem_design,session,contact,status,email FROM member_info");
	 ...
	 MemberTable()
	{
	    ...
	    add(p);
		tab.setRowHeight(35);
		tab.setPreferredScrollableViewportSize(new Dimension(1200,400));
		...
		setVisible(true);
	     ...
	     btnPrint.setBounds(595,30,100,30);
		 p4.add(btnPrint);
		 btnPrint.setBackground(new Color(135,206,250));
		 btnPrint.setFocusPainted(false);
	     
		 btnExit.setBounds(760,30,100,30);
		 p4.add(btnExit);
